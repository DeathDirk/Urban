...
#1
print_params()
print_params(3, 'savage')
print_params(None, 2, 'euc')

print_params(c=[1, 2, 3])  #working
print_params(b=25)  #working

#2
valies_list = [2, 'test_list', False]
valies_dict = {'a': 3, 'b': 'test_dict', 'c': False}
